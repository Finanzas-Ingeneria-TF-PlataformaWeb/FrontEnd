...
<template>
  <div class="card">
    ...
    <label for="blind-input" class="avatar">
      <!-- (svg del mono igual que lo tienes) -->
      <svg
...
/* avatar y animaciones (igual que antes) */
...
/* modo blind: oculta el texto del password */
